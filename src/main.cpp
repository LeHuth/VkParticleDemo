...
private:
    ...
    {
        auto vertShaderCode = readFile("shaders/vert.frag.spv");
        auto fragShaderCode = readFile("shaders/frag.vert.spv");
    ...
    void createInstance() {
        ...
        if (isMacOS()) {  // You can implement this helper function to check macOS
